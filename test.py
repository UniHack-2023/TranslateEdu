...
class AudioTranslatorApp:
    def __init__(self, master):
        ...
        self.download_button = ctk.CTkButton(sidebar_frame, text="Download Audio", command=self.download_audio,fg_color=btn_color).pack(pady=10)
        self.label = ctk.CTkLabel(sidebar_frame, text="Or select an existing audio file:",text_color="black").pack(pady=10)
        self.select_button = ctk.CTkButton(sidebar_frame, text="Select File", command=self.select_file,fg_color=btn_color).pack(pady=10)
        self.selected_language = ctk.StringVar()
        self.language_label = ctk.CTkLabel(sidebar_frame, text="Select input language:",text_color="black").pack(pady=10)
        ...
        self.translate_button = ctk.CTkButton(sidebar_frame, text="Translate", command=self.translate,fg_color=btn_color).pack(pady=10)
